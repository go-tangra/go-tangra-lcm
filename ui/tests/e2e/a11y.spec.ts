...
// T070 / SC-006: every lcm view inside the shell, both themes, zero serious or
...
const routes = ['/lcm',  '/lcm/certificates',  '/lcm/issuers',  '/lcm/requests',  '/lcm/permissions',  '/lcm/secrets',  '/lcm/audit']

test.describe('lcm accessibility', () => {
