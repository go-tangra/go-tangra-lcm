...
// The lcm UI is a federated remote served by the module under /ui/ and relayed
// by the gateway at /m/lcm/; `vite` alone runs a standalone dev shell
// (src/main.ts) against the gateway.
export default defineConfig({
  ...
  test: {
    environment: 'jsdom',
    environmentOptions: { jsdom: { url: 'https://localhost/lcm' } },
