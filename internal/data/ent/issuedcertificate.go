...
type IssuedCertificate struct {
	...
	// True if adopted from an external CA (not originally issued by LCM)
	IsExternal bool `json:"is_external,omitempty"`
	// Per-cert ACME directory URL (e.g. DigiCert order-specific renew URL). Overrides the issuer endpoint when set.
	AcmeDirectoryURLOverride string `json:"acme_directory_url_override,omitempty"`
...
func (*IssuedCertificate) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case issuedcertificate.FieldDomains, issuedcertificate.FieldIPAddresses:
			values[i] = new([]byte)
		case issuedcertificate.FieldServerGeneratedKey, issuedcertificate.FieldIsExternal, issuedcertificate.FieldAutoRenewEnabled:
		...
		case issuedcertificate.FieldID, issuedcertificate.FieldClientID, issuedcertificate.FieldIssuerName, issuedcertificate.FieldIssuerType, issuedcertificate.FieldCommonName, issuedcertificate.FieldStatus, issuedcertificate.FieldCertPem, issuedcertificate.FieldPrivateKeyPem, issuedcertificate.FieldAcmeDirectoryURLOverride, issuedcertificate.FieldCaCertPem, issuedcertificate.FieldCsrPem, issuedcertificate.FieldCertificateFingerprint, issuedcertificate.FieldErrorMessage, issuedcertificate.FieldKeyType, issuedcertificate.FieldRevokedReason:
...
func (_m *IssuedCertificate) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case issuedcertificate.FieldAcmeDirectoryURLOverride:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field acme_directory_url_override", values[i])
			} else if value.Valid {
				_m.AcmeDirectoryURLOverride = value.String
			}
...
func (_m *IssuedCertificate) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("acme_directory_url_override=")
	builder.WriteString(_m.AcmeDirectoryURLOverride)
	builder.WriteString(", ")
